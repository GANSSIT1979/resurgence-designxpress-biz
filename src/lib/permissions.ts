...
export const permissionCatalog = [
  ...
  { key: 'sponsor.placements.manage', label: 'Sponsor feed placement requests', area: 'Sponsor' },
...
const pageRouteRules: readonly RoutePermissionRule[] = [
  ...
  { prefix: '/sponsor/placements', permission: 'sponsor.placements.manage' },
...
const apiRouteRules: readonly RoutePermissionRule[] = [
  ...
  { prefix: '/api/sponsor/placements', permission: 'sponsor.placements.manage' },
