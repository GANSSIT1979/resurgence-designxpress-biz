...
export const api = {
  ...
  trackProductClick: (input: { postId?: string; productId?: string; creatorId?: string; affiliateCode?: string }) =>
    safePost('/api/affiliate/events/click', { ...input, source: 'mobile-feed' }),
}
