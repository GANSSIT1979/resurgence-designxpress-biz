...
async function main() {
  ...
  const shopCategories = [
    ...
    },
    {
      ...
      description: 'Hoodies, warmups, and practice-ready apparel.',
      sortOrder: 2,
      isActive: true,
    },
    {
      ...
      description: 'Everyday shirts and community merch for fans and supporters.',
      sortOrder: 3,
      isActive: true,
    },
    {
    ...
    },
    {
      name: 'Creator Drops',
      slug: 'creator-drops',
      description: 'Limited creator-led merch capsules and signature releases.',
      sortOrder: 5,
      isActive: true,
    },
  ];
  ...
  const shopProducts = [
    {
      name: 'Resurgence Pro Jersey - Black/Red',
      slug: 'resurgence-black-jersey',
      sku: 'RSG-JSY-PRO-001',
      description: 'Official Resurgence performance jersey in black and red with a lightweight athletic feel, sponsor-ready front presentation, and premium court identity.',
      shortDescription: 'Official black and red performance jersey',
      price: 1499,
      compareAtPrice: 1799,
      stock: 50,
      imageUrl: '/assets/resurgence-poster.jpg',
      badgeLabel: 'Official Jersey Drop',
      material: 'Performance polyester mesh',
      fitNotes: 'Athletic fit. Size up for relaxed streetwear styling.',
      careInstructions: 'Machine wash cold, do not bleach, hang dry, and avoid ironing directly on printed areas.',
    ...
    },
    {
      ...
      sku: 'RSG-HOD-TRAIN-001',
      description: 'Comfort-fit hoodie for players, creators, and supporters with premium Resurgence branding, warm travel weight, and clean off-court styling.',
      shortDescription: 'Heavyweight training hoodie',
      price: 1599,
      compareAtPrice: 1899,
      stock: 25,
      imageUrl: '/assets/jake-image2.jpg',
      badgeLabel: 'Training Essential',
      material: 'Cotton fleece blend',
      fitNotes: 'Relaxed fit with roomy sleeves.',
      careInstructions: 'Wash inside out with similar colors. Tumble dry low or hang dry.',
    ...
    {
      name: 'Resurgence Court Tee',
      slug: 'resurgence-court-tee',
      sku: 'RSG-TEE-COURT-001',
      description: 'Official everyday court tee designed for community games, creator shoots, sponsor activations, and casual fan wear.',
      shortDescription: 'Core team tee for everyday wear',
      price: 699,
      compareAtPrice: 899,
      stock: 80,
      ...
      fitNotes: 'Regular unisex fit.',
      careInstructions: 'Machine wash cold and hang dry for best print life.',
    ...
    },
    {
      ...
      badgeLabel: 'Signature Accessory',
      material: 'Structured cotton twill',
      fitNotes: 'Adjustable back strap. One size fits most.',
    ...
    {
      name: 'DesignXpress Game Shorts',
      slug: 'designxpress-game-shorts',
      sku: 'RSG-SHORTS-GAME-001',
      description: 'Lightweight game shorts for training runs, pickup games, event days, and brand ambassador appearances.',
      shortDescription: 'Lightweight game shorts',
      price: 899,
      compareAtPrice: 1099,
      stock: 45,
      imageUrl: '/assets/resurgence-poster.jpg',
      badgeLabel: 'Court Essential',
      material: 'Breathable sports mesh',
      fitNotes: 'Athletic basketball cut with adjustable waist.',
    ...
    {
      name: 'Resurgence Courtside Tumbler',
      slug: 'resurgence-courtside-tumbler',
      sku: 'RSG-TMB-001',
      description: 'Reusable courtside tumbler for practices, games, errands, and sponsor activation kits.',
      shortDescription: 'Reusable merch tumbler',
      price: 449,
      compareAtPrice: 599,
      stock: 75,
      imageUrl: '/assets/resurgence-logo.jpg',
      badgeLabel: 'Hydration Gear',
      material: 'Insulated stainless steel',
      fitNotes: '20oz capacity.',
      careInstructions: 'Hand wash recommended. Do not microwave.',
      availableSizes: '20oz',
      availableColors: 'Black',
      isOfficialMerch: true,
      sortOrder: 6,
    ...
    {
      name: 'Jake Anilao Creator Tee',
      slug: 'jake-anilao-creator-tee',
      sku: 'RSG-CR-JAKE-TEE-001',
      description: 'Creator-led Jake Anilao tee for fans, basketball community events, and influencer campaign drops.',
      shortDescription: 'Jake Anilao creator capsule tee',
      price: 799,
      compareAtPrice: 999,
      stock: 35,
      imageUrl: '/assets/jake-image1.jpg',
      badgeLabel: 'Creator Drop',
      material: 'Premium cotton jersey',
      fitNotes: 'Regular unisex fit.',
      careInstructions: 'Wash inside out, cold cycle, hang dry.',
      availableSizes: 'S, M, L, XL, 2XL',
      availableColors: 'Black',
      isOfficialMerch: true,
      sortOrder: 7,
  ...
  const shopCategoryRecords = new Map<string, string>();
  for (const category of shopCategories) {
    const record = await prisma.shopCategory.upsert({
      where: { slug: category.slug },
      update: category,
      create: category,
    });
    shopCategoryRecords.set(category.slug, record.id);
  }

  for (const product of shopProducts) {
    const { categorySlug, ...productData } = product;
    const categoryId = shopCategoryRecords.get(categorySlug) || null;
