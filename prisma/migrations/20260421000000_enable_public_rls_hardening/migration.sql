-- Keep this migration aligned with prisma/postgres-hardening.sql.
-- Supabase exposes the public schema via PostgREST, so every public table needs RLS.
-- No policies are added here on purpose: the default posture is deny-by-default
-- until explicit API access rules are designed.
