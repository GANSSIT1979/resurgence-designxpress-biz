-- Keep this migration aligned with prisma/postgres-public-read-policies.sql.
-- Only expose tables whose full rows are already safe for public Data API reads.
